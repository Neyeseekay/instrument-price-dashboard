  ...
  return (
    <div ref={rootRef} className="relative w-full">
      <input
        ...
        className="w-full rounded-md border border-hairline bg-surface px-3 py-2 text-ink shadow-sm placeholder:text-ink-muted focus:outline-none focus:ring-2 focus:ring-brand disabled:cursor-not-allowed disabled:opacity-50"
      />
